...
import numpy as np
import winsound  # For Windows beep sound (use 'beep' for Linux)

# Email configuration
EMAIL_ADDRESS = "carljosephbornrich@gmail.com"  # Replace with your email
EMAIL_PASSWORD = "wyvm jfnk anwz xyvo"   # Use App Password if using Gmail
...
class UnattendedObjectDetector:
    ...
    def send_email_alert(self):
        try:
            msg = MIMEText("Unattended/misplaced object detected at " + 
                    ...
                    if self.object_detected_time is None:
                        ...
                        if elapsed_time >= self.unattended_threshold:
                            ...
                            if not self.email_sent:
                                self.email_sent = self.send_email_alert()
